...
export const UPCOMING_NORTH_NATHULA = {
        id: "1",
        image: "images/north-sikkim/north",
        cover:'images/north-sikkim/upcomingNorthSikkim',
        title: "North Sikkim + Nathula Pass",
        pdf:'pdf/NorthsikkimNathulaPass',
        ...
        photoGalleries: [
          ...
          {
            title: "north sikkim",
            images: "images/north-sikkim/1",
          },
          {
            title: "north sikkim",
            images: "images/north-sikkim/2",
          },
          {
            title: "north sikkim",
            images: "images/north-sikkim/3",
          },
          {
            title: "north sikkim",
            images: "images/north-sikkim/4",
          },
          {
            title: "north sikkim",
            images: "images/north-sikkim/5",
          },
          {
            title: "north sikkim",
            images: "images/north-sikkim/6",
          },
          {
            title: "north sikkim",
            images: "images/north-sikkim/7",
          },
          {
            title: "north sikkim",
            images: "images/north-sikkim/8",
          },
          {
            title: "north sikkim",
            images: "images/north-sikkim/9",
          },
          {
            title: "north sikkim",
            images: "images/north-sikkim/10",
          },
          {
            title: "north sikkim",
            images: "images/north-sikkim/11",
          },
          {
            title: "north sikkim",
            images: "images/north-sikkim/12",
          },
        ],
        detailedItinerary: [
          {
          ...
          },
          {
            ...
            activities: [
              ...
              "Next, we will visit Nathula Pass, an Indo-China border post (Note: Nathula Pass is closed on Monday)",
              "We will then visit the Old Baba Mandir, which holds historical significance and offers a tranquil environment.",
              "Our journey will continue to Nathang Valley, a picturesque valley known for its breathtaking landscapes and serene beauty.",
              "We will then proceed to Kupup Lake, a beautiful high-altitude lake surrounded by stunning scenery.",
              "Our journey will continue to Thambi View Point, also known as Silk route viewpoint offering breathtaking panoramic views of the surrounding mountains.",
